...
limite_inferior <- pnbinom(p = (-desviacion_std+media), size = size, prob = prob)
limite_superior <- pnbinom(p = (desviacion_std+media), size = size, prob = prob)

probabilidad <- limite_superior - limite_inferior
