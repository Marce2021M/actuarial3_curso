...
datos <- data.frame(
  ...
  Perdida = c(16.4, 86.6, 18.1, 29.8, 4.8, 28.9, 8.9, 32)
)
...
```
   ...
   iii) Si la Aseguradora cobra una prima de riesgo de 20% sobre el valor esperado de las pérdidas, ¿cuál es la probabilidad de que pierda dinero en un año? [5]

```{r}
# Probabilidad de que pierda dinero en un año
